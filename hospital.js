...
class Hospital {
    constructor(name, location) {
        ...
        this.employees = ['Irwin','Prata','Jaya','Iqbal','Muhammad']
        this.username = ['irwin','prata','jaya','iqbal','muhammad']
        this.pass = [1,2,3,4,5]
        this.position = ['Doctor','Admin','Receptionist','Officeboy','Patient']
        this.patients = [{id:1, name:"hattori", diagnose:"sakit perut"},{id:2, name:"conan", diagnose:"sakit kepala"}]
        this.id = 0
  }
  ...
  login(){
      rl.question('\n\nMasukkan username anda(irwin, prata, jaya, iqbal, muhammad)\nUsername : ', (answer) => {
