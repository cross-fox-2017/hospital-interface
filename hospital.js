...
class Hospital {
    constructor(name, location) {
        ...
        this.employees = ['Snow','Rob','Bran','Rick','Patient']
        this.username = ['snow','rob','bran','rick','patient']
        this.position = ['Doctor','Admin','Receptionist','Officeboy','Patient']
        this.patients = [{id:1, name:"aa", diagnose:"flu"},{id:2, name:"bb", diagnose:"batuk"}]
        this.id = 0
  }
  ...
  login(){
      rl.question('\n\nPlease enter your username (hint : snow / rob / bran / rick / patient)\nInput : ', (answer) => {
  ...
  password(){
      rl.question('\n\nPlease enter your Password (hint : just enter your username once again)\nInput : ', (answer) => {
...
let tes = new Hospital('Stark','Winterfell')
tes.header()
